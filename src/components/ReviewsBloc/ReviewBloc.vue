  ...
  <section class="reviews__bloc container">
    <div class="reviews__bloc-swiper">
      <swiper @swiper="onSwiper" :navigation="false" :modules="modules" class="reviews__bloc-swiper-widget">
        <swiper-slide class="reviews__bloc-swiper-widget-slide">
          ...
          <p class="reviews__bloc-swiper-widget-slide-review">
            Едем по дороге в аэропорт, ещё не улетели начала писать отзыв. Морокко-это сказка, сказка востока, как нам
            её
            преподнёс наш гид Идрис, вписал в нас всю культуру, всю историю, все вкусности этой страны. Было
            незабываемо,
            интересно, познавательно, а какая была у нас замечательная группа. Нам было мало, мало этой сказки Магриба,
            надеюсь повторить это неизгладимое путешествие. Спасибо огромное Ванд групп, особенно Наталье, и нашему гиду
            в
            Марокко Идрису.
          </p>
        </swiper-slide>
      </swiper>
      <div class="reviews__bloc-swiper-btns">
